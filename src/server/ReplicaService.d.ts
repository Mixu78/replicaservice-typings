...
export interface ReplicaService {
   ...
   */
  readonly ActivePlayers: ReadonlyMap<Player, boolean>;
  /**
   ...
   *
   * **ReplicaService.Temporary Example:** TODO
   */
  Temporary: Replica;
  /**
   ...
   *
   * - **ClassToken** \- Sets `Replica.Class` to the string provided in `ReplicaService.NewClassToken(className)`.
   ...
   * - **Data** \- (Default: `{}` empty table) A table representing a state. Using `Profile.Data` from [ProfileService](https://madstudioroblox.github.io/ProfileService/) is valid!
